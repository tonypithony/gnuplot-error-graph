...
set label "L_{10%} = AB" left at 0.54, 12.1 offset .5, 0
set arrow from 0.54, 12.0 to 0.32, 2.3 lt -1 lw 2 #front size 10, 15
...
plot [0:1] (a*x+b)*100 lt -1 lw 1 lc rgb 'black' ti 'Интерферометрия', \
...
(a1*x+b1)*100 lt 0 lw 2 lc rgb 'black' ti 'Интерферометрия_{opt}', \
